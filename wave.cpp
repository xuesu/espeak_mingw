...
//      myOutputParameters.suggestedLatency = aCoeff * aLatency;  // to avoid glitches ?
      ...
      SHOW("Device=%d, myOutputParameters.suggestedLatency=%f\n",
	   selectedDevice,
